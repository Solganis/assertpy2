...
if TYPE_CHECKING:
    ...
    class _StructureAssertion(Protocol):
        """Quantifiers and the JSON family, which a mapping and a sequence share.
    ...
    class _StringAssertion(
        _MembershipAssertion, _FilesystemAssertion, _RepeatableAssertion[str], _SizedAssertion, _CoreAssertion, Protocol
    ):
        ...
        def filtered_on(self, predicate: Matcher | Callable[..., bool]) -> _IterableAssertion[str]: ...
        def mapped(self, func: Callable[[str], _R]) -> _IterableAssertion[_R]: ...
        def flat_mapped(self, func: Callable[[str], Iterable[_R]]) -> _IterableAssertion[_R]: ...
    ...
    class _DictAssertion(_MembershipAssertion, _StructureAssertion, _SizedAssertion, _CoreAssertion, Protocol[_K, _V]):
        ...
        def filtered_on(self, predicate: Matcher | Callable[..., bool]) -> _IterableAssertion[_K]: ...
        def mapped(self, func: Callable[[_K], _R]) -> _IterableAssertion[_R]: ...
        def flat_mapped(self, func: Callable[[_K], Iterable[_R]]) -> _IterableAssertion[_R]: ...
    ...
    class _BytesAssertion(_MembershipAssertion, _SizedAssertion, _CoreAssertion, Protocol[_B_co]):
        ...
        def filtered_on(self, predicate: Matcher | Callable[..., bool]) -> _IterableAssertion[int]: ...
        def mapped(self, func: Callable[[int], _R]) -> _IterableAssertion[_R]: ...
        def flat_mapped(self, func: Callable[[int], Iterable[_R]]) -> _IterableAssertion[_R]: ...
