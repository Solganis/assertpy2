...
if TYPE_CHECKING:
    ...
    class _CoreAssertion(Protocol):
        ...
        # a protocol narrowing `satisfies` restates the whole overload set, ladder included
        @overload
    ...
    class _DateAssertion(_CoreAssertion, Protocol):
        ...
        # `datetime` and not `date`: these seven refuse a plain date on the value as well as the operand
