...
BASELINE: dict[tuple[str, str], int] = {
    ...
    ("assertpy2/helpers.py", "reportArgumentType"): 2,
...
LADDER_OVERLAP: dict[tuple[str, str], int] = {
    ...
    ("assertpy2/_engine/_poll_typing.py", "is_even"): 4,
    ("assertpy2/_engine/_poll_typing.py", "is_odd"): 4,
    ("assertpy2/_engine/_poll_typing.py", "is_divisible_by"): 4,
    ...
    ("assertpy2/_engine/_poll_typing.py", "is_close_to"): 4,
    ("assertpy2/_engine/_poll_typing.py", "is_between"): 4,
    ("assertpy2/_engine/_poll_typing.py", "is_greater_than"): 4,
    ("assertpy2/_engine/_poll_typing.py", "is_greater_than_or_equal_to"): 4,
    ("assertpy2/_engine/_poll_typing.py", "is_instance_of"): 4,
    ("assertpy2/_engine/_poll_typing.py", "is_instance_of_any"): 4,
