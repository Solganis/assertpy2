...
| The type your chain has after each step | [`test_typing.py`](https://github.com/Solganis/assertpy2/blob/main/tests/test_typing.py), 197 `assert_type` checks under ty, mypy `--strict`, Pyright and Pyrefly, zero suppressions |
